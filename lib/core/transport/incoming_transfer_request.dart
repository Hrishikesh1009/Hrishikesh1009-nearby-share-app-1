...
class IncomingTransferRequest {
  IncomingTransferRequest({
    ...
    required Future<void> Function(String savePath, void Function(int bytes) onProgress) onAccept,
  ...
  final Future<void> Function(String savePath, void Function(int bytes) onProgress) _onAccept;
  final Future<void> Function() _onDecline;

  Future<void> accept(String savePath, {required void Function(int bytes) onProgress}) =>
      _onAccept(savePath, onProgress);
